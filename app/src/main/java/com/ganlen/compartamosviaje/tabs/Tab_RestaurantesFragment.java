...
public class Tab_RestaurantesFragment extends Fragment {
    ...
    public static final String FB_Database_Path = "restaurantes";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab_restaurantes, container, false);
        final ArrayList imgList = new ArrayList<>();
        lv = (ListView) view.findViewById(R.id.listViewImage);
        dialog = ProgressDialog.show(getActivity(), "Por favor espera", "Cargando restaurantes...",true);
